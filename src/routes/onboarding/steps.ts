// Locked teaching copy for the onboarding wizard (decision 02).
// Mirrors the prototype asset's content — this is the build's source of truth;
// the prototype route is throwaway (cleanup ticket 06).
