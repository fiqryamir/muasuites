...
> Captured: `2026-08-10T08:57:15.501Z` · via Supabase Management API (PAT) · source of truth: **live cloud, not local migrations**
...
## RPC functions (7) — full definitions
...
## REST surface (14 PostgREST paths from openapi)
...
- ~3,856 words / ~5,013 tokens (rough)
