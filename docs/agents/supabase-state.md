...
> Captured: `2026-08-10T05:31:06.858Z` · via Supabase Management API (PAT) · source of truth: **live cloud, not local migrations**
...
```json
{
  "uri_allow_list": "https://muasuite.com/**",
  "jwt_exp": 3600,
...
- ~3,828 words / ~4,976 tokens (rough)
